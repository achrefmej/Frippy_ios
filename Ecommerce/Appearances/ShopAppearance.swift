...
public class ShopAppearance: DSDesignable {
    ...
    public init(brandColor: UIColor? = nil, title: String = "Shop") {
        ...
        let button = DSDesignableButtonColor(background: UIColor(0xFF9900), title: UIColor(0xffffff))
      ...
      //                                       title: DSColor.color(light: 0xEBC893, dark: 0xEBC893))
       ...
       // let background = DSColor.color(light: 0xFFFFF, dark: 0x15202b)
        ...
        price = DSDesignablePriceColor(currency: UIColor(0xFF9900),
                                       amount: UIColor(0xFF9900),
