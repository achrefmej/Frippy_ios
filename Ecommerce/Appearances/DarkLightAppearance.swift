...
public class DarkLightAppearance: DSDesignable {
    ...
    public init(brandColor: UIColor? = nil) {
        ...
        self.title = "DSKit"
        self.brandColor = brandColor ?? DSColor.color(light: 0xFF9900, dark: 0xFF9900)
        
        // MARK: - Primary view
        
        // Text
        let text = DSDesignableTextColor(largeTitle: DSColor.color(light: 0xF56300, dark: 0xF56300),
        ...
        // Button
        let sButton = DSDesignableButtonColor(background: DSColor.color(light: 0xBA9763, dark: 0x8899a6),
